...
X = /\(\)$/, Ua = q.util.escapeRegex, ya = f("<div>")[0], $b = ya.textContent !== p, bc = /<.*?>/g,
    ...
    oPaginate: {
    sFirst: "First", sLast: "Laatste",
    sNext: "Volgende", sPrevious: "Vorige"
    },
    sEmptyTable: "Geen data gevonden",
    sInfo: " _START_ tot _END_, van de _TOTAL_ records",
    sInfoEmpty: "0 tot 0 van de 0 records",
    sInfoFiltered: "(filtered van _MAX_ totaal records)",
    sInfoPostFix: "",
    sDecimal: "",
    sThousands: ",",
