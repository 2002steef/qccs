    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div id="popupBackground">
                <div id="popupContent">
                    <h1 class="popupText" style="color: black">Weet u zeker dat u bij -masseusebedrijf- een afspraak wilt maken?</h1>
                    <p class="popupText" style="color: black">>uitleg over hoe het werkt en zomeer regel 1<br>
