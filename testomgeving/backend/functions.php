    ...
    while ($masseuse = $resultMasseuse->fetch_array()) { ?>
        <tr>
            ...
            <td><a class="btn btn-outline-light-grey" href="masseuse_profiel.php?masseuseID=<?= $masseuse["masseuseID"] ?>">
                ...
                <br>
                <br>
                <button type="button" onclick="changepopup(<?php $masseuse['masseuseID'] ?>)" class="btn btn-outline-light-grey" data-toggle="modal" data-target="#default">Maak afspraak</button>
            </td>
        </tr>
    <?php }
