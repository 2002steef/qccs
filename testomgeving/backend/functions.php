...
function masseuseInfo()
{
    ...
    while ($masseuse = $resultMasseuse->fetch_array()) { ?>
        <tr>
            <td colspan="1"><img src="img/profile/<?= $masseuse["profielFoto"] ?>" width="150px" height="150px" alt="masseuse foto"></td>
            <td colspan="3"><?= $masseuse["voornaam"] ?></td>
            <td colspan="1"><a class="btn btn-outline-light-grey" href="masseuse_profiel.php?masseuseID=<?= $masseuse["masseuseID"] ?>">
                    Meer info
                </a>
            </td>
        </tr>
