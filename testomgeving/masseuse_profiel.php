                                                ...
                                                <div class="card-content hidescroll ">
                                                    <div class="card-body">
                                                        <p class="m-0 scrolltext">
                                                            ...
                                                            <input type="text" name="straat" readonly value="<?= $masseuse["straat"]; ?>" class="form-control-plaintext col-5 row"></input>
                                                            <input class="form-control-plaintext col-2 row" readonly type="text" name="huisNummer" value="<?= $masseuse["huisNummer"]; ?>"></input>
                                                            <input class="form-control-plaintext col-2 row" readonly type="text" name="huisNummerToevoeging" value="<?= $masseuse["huisNummerToevoeging"]; ?>"></input>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
