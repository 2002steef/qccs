                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="user-profile-images">
                                        <!-- user timeline image -->
                                        <img src="img/uploads/<?= $masseuse["bannerFoto"]; ?>" class="img-fluid rounded-top user-timeline-image" alt="Banner">
                                        <!-- user profile image -->
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card" id="aboutCompany">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <p class="m-0">
                                                            <textarea rows="10" type="text" class=" form-control-plaintext" readonly><?= substr($masseuse["paragraafje"], 0, 350) . "..."; ?>...  </textarea>
                                                        </p>
                                                    </div>
                                                    <?php if (isset($_SESSION["status"]) && $_SESSION["status"] == "masseuse") { ?>
