...
<body class="vertical-layout vertical-menu 2-columns  navbar-static layout-dark layout-transparent bg-glass-1" data-bg-img="bg-glass-1" data-menu="vertical-menu" data-col="2-columns">
    ...
    <div class="wrapper">
        <div class="main-panel">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                                <div class="media">
                                                    <img src="uploads/<?= $user['image_url'] ?>" alt="profile-img" class="rounded mr-3" height="64" width="64">
                                                ...
                                                <form method="post" action="page-account-settings.php">
                                                    <div class="klant">
                                                        ...
                                                        <div class="col-12 form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="email" id="email" name="email" class="form-control" placeholder="E-mail" value="<?php echo $user['email']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 form-group">
                                                            <div class="controls">
                                                                <input type="hidden" id="email" name="email" class="form-control" placeholder="E-mail" value="<?php echo $user['email']; ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 d-flex flex-sm-klant flex-column justify-content-end">
                                                            <button type="submit" name="save" class="btn btn-primary mr-sm-2 mb-1">Save Changes</button>
                                                            <a href="overzicht.php?user_ID=<?= $_SESSION["id"] ?> " class="btn btn-outline-light-gray mb-1">
                                                                Cancel
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
                                                <form method="post">
                                                    ...
                                                    <div class="d-flex flex-sm-klant flex-column justify-content-end">
            ...
            <button class="btn btn-primary scroll-top" type="button"><i class="ft-arklant-up"></i></button>
