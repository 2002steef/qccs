...
<?php
    ...
    if (isset($_POST['updateKlant']))
    {
        ...
        $stmt->bind_param('sssssssssssssssssssssssi', $_POST["match-datum"], $_POST["voornaam"], $tussenvoegsel, $_POST["achternaam"],
        ...
        $_POST["materiaal"], $_POST["klant_wensen"], $_POST["offertes"], $_POST["nagebeld"], $_POST["gewenste_aanvang"], $afspraakdatum, $klantScore, $_GET["Project_ID"]);
        $stmt->execute();
    }
}
